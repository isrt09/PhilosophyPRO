...
<article <?php post_class("masonry__brick entry format-audio") ?> data-aos="fade-up">
	<div class="entry__thumb">
	    ...
	    <div class="audio-wrap">
	        <audio id="player" src="<?php echo esc_url($philosophy_audio_file);?>/media/AirReview-Landmarks-02-ChasingCorporate.mp3" width="100%" height="42" controls="controls"></audio>
	    </div>
	</div>
